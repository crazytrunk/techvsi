jQuery(document).ready(function($){
    ...
    function nextSection(event) {
		...
		var scroll;
		if( typeof visibleSection[0] === "undefined" ) {
			scroll = true;
		} else {
			scroll = Math.ceil(visibleSection.scrollTop() + visibleSection.innerHeight()) >= visibleSection[0].scrollHeight;
		}
		
        if(!animating && !visibleSection.is(":last-of-type") && scroll) {
            animating = true;
